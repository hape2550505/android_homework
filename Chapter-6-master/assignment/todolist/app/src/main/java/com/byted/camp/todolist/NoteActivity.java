...
public class NoteActivity extends AppCompatActivity {
    ...
    private boolean saveNote2Database(String content) {
       ...
       SQLiteDatabase db = dbHelper.getWritableDatabase();
        ...
        values.put(TodoContract.TodoEntry.COLUMN_NAME_TIMESTAMP,timestamp);
        ...
        Log.i("DatabaseActivity", "perform add data, result:" + newRowId);
        Log.i("DatabaseActivity", timestamp);
